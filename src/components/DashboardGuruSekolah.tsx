...
export default function DashboardGuruSekolah({ 
  ...
  const handleSubmitPresensiQuick = async (
    ...
    try {
      ...
      const statusLokasiDb = dist <= DEFAULT_SCHOOL_LOCATION.radiusMeters ? "Dalam Jangkauan" : "Luar Jangkauan";
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="px-2 py-1 rounded-lg bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 flex flex-col items-center justify-center font-bold text-[10px] shrink-0 font-mono">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                            ...
                            <span>•</span>
                            <span className="font-medium text-slate-600 dark:text-slate-300">{displayNama}</span>
                            <span>•</span>
